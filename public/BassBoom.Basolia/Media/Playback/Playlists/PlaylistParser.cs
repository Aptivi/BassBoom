...
using BassBoom.Basolia.Media.Playback.Playlists.Instances;
...
namespace BassBoom.Basolia.Media.Playback.Playlists
{
    /// <summary>
        ...
        public static Playlist ParsePlaylistFrom(string playlist, string fileParent = "")
        {
            ...
            for (int i = 0; i < lines.Length; i++)
            {
                ...
                else
                {
                    ...
                    if (FileIo.Exists(absolutePath) && BasoliaMedia.SupportedExtensions.Contains(extension))
