...
"%ProgramFiles%\dotnet\dotnet.exe" restore "..\BassBoom.sln" -p:Configuration=%releaseconfig%
...
"%ProgramFiles%\dotnet\dotnet.exe" build "..\BassBoom.sln" -p:Configuration=%releaseconfig%
