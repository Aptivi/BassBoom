...
pushd %ROOTDIR%\tools\
"%ProgramFiles%\7-Zip\7z.exe" x %TEMP%\mpv-dev-x86_64-20250422-git-b8ab107.7z libmpv-2.dll
popd
...
pushd %ROOTDIR%\tools\
"%ProgramFiles%\7-Zip\7z.exe" x %TEMP%\mpv-dev-aarch64-20250422-git-b8ab107.7z libmpv-2.dll
popd
