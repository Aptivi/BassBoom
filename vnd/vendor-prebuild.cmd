...
pushd "%ROOTDIR%\tools\"
"%ProgramFiles%\7-Zip\7z.exe" x "%TEMP%\mpv-dev-x86_64-20250511-git-b3070d1.7z" libmpv-2.dll
popd
...
pushd "%ROOTDIR%\tools\"
"%ProgramFiles%\7-Zip\7z.exe" x "%TEMP%\mpv-dev-aarch64-20250511-git-b3070d1.7z" libmpv-2.dll
popd
