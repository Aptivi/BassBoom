...
localize() {
    ...
    curl -L --output "$ROOTDIR/vnd/mpv-dev-x86_64-20250602-git-730062b.7z" https://github.com/zhongfly/mpv-winbuild/releases/download/2025-06-02-730062b/mpv-dev-x86_64-20250602-git-730062b.7z
    curl -L --output "$ROOTDIR/vnd/mpv-dev-aarch64-20250602-git-730062b.7z" https://github.com/zhongfly/mpv-winbuild/releases/download/2025-06-02-730062b/mpv-dev-aarch64-20250602-git-730062b.7z
...
prebuild() {
    ...
    if [ ! -f $ROOTDIR/vnd/mpv-dev-x86_64-20250602-git-730062b.7z ]; then
        curl -L --output $ROOTDIR/vnd/mpv-dev-x86_64-20250602-git-730062b.7z https://github.com/zhongfly/mpv-winbuild/releases/download/2025-06-02-730062b/mpv-dev-x86_64-20250602-git-730062b.7z
        checkvendorerror $?
    fi
    if [ ! -f $ROOTDIR/vnd/mpv-dev-aarch64-20250602-git-730062b.7z ]; then
        curl -L --output $ROOTDIR/vnd/mpv-dev-aarch64-20250602-git-730062b.7z https://github.com/zhongfly/mpv-winbuild/releases/download/2025-06-02-730062b/mpv-dev-aarch64-20250602-git-730062b.7z
        checkvendorerror $?
    fi

    # Install the DLL for AMD64
    cd $ROOTDIR/vnd && "$sevenzpath" x $ROOTDIR/vnd/mpv-dev-x86_64-20250602-git-730062b.7z libmpv-2.dll && cd -
    checkvendorerror $?
    ...
    cd $ROOTDIR/vnd && "$sevenzpath" x $ROOTDIR/vnd/mpv-dev-aarch64-20250602-git-730062b.7z libmpv-2.dll && cd -
    checkvendorerror $?
